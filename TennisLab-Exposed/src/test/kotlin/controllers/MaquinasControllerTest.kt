...
internal class MaquinasControllerTest {
    ...
    fun getMaquinaPersonzalizarByIdNoExiste() {
        ...
        val res =
            assertThrows<MaquinaPersonalizarException> { maquinasController.getMaquinaPersonalizar(maquinaPersonalizar.id) }
    ...
    fun deleteMaquinaPersonalizarNoExiste() {
        ...
        val res = assertThrows<MaquinaPersonalizarException> {
